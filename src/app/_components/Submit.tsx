...
const Page = () => {
    return (
        <div className='  h-full w-full flex justify-center items-center'>
            <div className='w-1/2'>
                <div className='w-2/3'>
                    <div className='text-3xl text-center mb-4'>Your results based on your answers:</div>
                    <div className=' flex w-full bg-white py-8 px-6 rounded-lg'>
                        <div className='w-2/3'>
                            <p className='text-black text-lg font-medium'>you are most suitable for </p>
                            <p className='text-xl font-semibold'>Association of Chartered </p>
                            <p className='text-xl font-semibold'>Certified Accountant <span className='text-orange-500'>(ACCA)</span></p>
                        ...
                        <div className=''>
                            <Image src={piechart} alt={piechart} className='w-full h-full' />
                        </div>
                    </div>
                </div>
